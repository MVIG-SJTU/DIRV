...
class ModelWithLoss(nn.Module):
    def __init__(self, model, debug=False):
        ...
        self.criterion_union = Union_Loss()
        self.criterion_instance = Instance_Loss()
        self.model = model
        self.debug = debug
                    ...
                    if iter % 20 == 0:
                        print(
                            ...
                            ' Total loss: {:.5f}. Learning rate: {:.5f}'.format(
                                step, epoch, opt.num_epochs, iter + 1, num_iter_per_epoch, union_loss, instance_loss, loss, current_lr))
